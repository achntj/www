    ...
    <>
      ...
      >
        <div className="w-full max-w-7xl md:h-[80vh] md:border border-[color:rgba(52,72,54,0.24)] dark:border-[color:rgba(122,136,125,0.24)] md:rounded-2xl overflow-hidden shadow-[0_24px_70px_-48px_rgba(24,27,24,0.6)] flex relative backdrop-blur-[0.75px] bg-white/90 dark:bg-[#070808]">
          ...
          <main
            ref={mainRef}
            className="panel-surface flex-1 p-6 md:p-10 pt-16 md:pt-10 type-reading md:type-reading leading-[1.62] tracking-[0.002em] font-[540] overflow-auto md:border-l border-[color:rgba(48,68,51,0.2)] dark:border-[color:rgba(105,118,107,0.26)] mt-0 min-h-screen md:min-h-full bg-white/80 dark:bg-black/20"
          >
            {children}
          </main>
        </div>
